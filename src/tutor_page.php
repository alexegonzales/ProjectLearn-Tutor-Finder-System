<?php
    ...
    $string1 = $_SESSION['firstname'];
    $string2 = $_SESSION['lastname'];
...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light sticky-top">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                ...
                <li class="nav-item">
                        <a class="nav-link opt active" href="tutor_page.php">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="cardt rounded-0 shadow">
                    ...
                    <div class="card-body">
                        <div class="container-fluid">
                            <form action="tutor_save_schedule.php" method="post" id="schedule-form">
    ...
    <?php 
        $schedules = $conn->query("SELECT * FROM `tutor_schedule` WHERE id=$id");
        $sched_res = [];
    ...
    <script src="js/tutor_sched.js"></script>
