                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-borderless">
                                <?php
                                    ...
                                    $select = mysqli_query($conn, "SELECT * FROM students WHERE id=$_SESSION[id]") or die(mysqli_error());
                        ...
                        <div class="modal fade" id="update<?php echo $_SESSION['id']?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="error"></div>
                                    <form action="update_query.php" method="POST" class="form-update">
                        ...
                        <div class="modal fade" id="delete<?php echo $_SESSION['id']?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="student_del_rev_fk.php?" method="GET">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button name="deleteStudent" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span>Delete</button>
                                        </div> 
                                    </form>
    ...
    <?php
        if(isset($_FILES["profile"]["name"])){
            ...
            if (!in_array($imageExtension, $validImageExtension)){
                ...
                $query = "UPDATE students SET profile = '$newImageName' WHERE id = $id";
                ...
                echo
                    "
                    <script>
                        document.location.href = 'student_acc_sett.php';
                    </script>
                    ";
            }
        }
