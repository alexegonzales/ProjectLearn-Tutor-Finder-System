<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        if (preg_match($namePattern, $fname) == 1) {
            ...
            $error ="Invalid First name. Whitespaces or digits are not allowed.";

        }elseif (preg_match($namePattern, $lname) == 1) {

            $error ="Invalid Last name. Whitespaces or digits are not allowed.";
            ...
            $error ="Password must contain 1 lowercase, 1 uppercase or a digit.";

        }elseif($pass == $cpass) {

            $select = "SELECT * FROM tutors WHERE email='$email'";
            ...
            if($select_result->num_rows > 0) {
                ...
                if (!in_array($imageExtension, $validImageExtension)){
                    ...
                    echo
                        ...
                        document.location.href = 'tutor_reg.php';
                        </script>
                        ";
                    ...
                    $insert = "INSERT INTO tutors (unique_id, firstname, lastname, email, contact, password, sex, profile, status, tutor_status, verification_status, credential, education, bio)
                    VALUES ('$ran_id', '$fname', '$lname', '$email', '$contact', '$hashPass', '$sex', '$profile', 3, '$tutor_status', '$verification_status', '$imageName', '$education', '$bio')";
                    ...
                    if($insert_result) {
                        ...
                        echo "<script>alert('Registration completed!'); window.location.href='tutor_reg.php';</script>";
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="card-body">
                                ...
                                <form action="" method="POST" class="login-email" enctype="multipart/form-data">
                                    ...
                                    <div id="credential" class="form-text">Compile all your credentials (certificates, project samples, etc) in a pdf file</div>
                                    ...
                                    <p class="login-register-text">Already have an account? <a href="tutor_login.php">Login Here</a></p>
                                </form>
                            </div>
                        </div>
                    </div>
