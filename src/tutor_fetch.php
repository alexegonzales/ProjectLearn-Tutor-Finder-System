<?php
    ...
    if(isset($_POST["view"])) {
        ...
        if($_POST["view"] != '') {
            ...
            $update_query = "UPDATE credibility SET notif_status = 1 WHERE receiver_id = '$tutor_id' AND notif_status = 0";
        ...
        $query = "SELECT * FROM credibility WHERE receiver_id = '$tutor_id' ORDER BY req_date DESC LIMIT 5";
        ...
        if(mysqli_num_rows($result) > 0) {
            ...
            while($row = mysqli_fetch_array($result)) {
                ...
                <li style = "padding-left: 7px;">
                    <a href="#.php" style="text-decoration: none; font-size: 15px; color: #000;">
        ...
        $sel_count = "SELECT * FROM credibility WHERE receiver_id = '$tutor_id' AND notif_status = 0";
