  ...
  <nav class="navbar navbar-expand-lg navbar-light sticky-top">
    ...
    <style>
        @media print {
            ...
            .print-container, .title, .doc-header img, .print-container * {
                visibility: visible;
            }

            .print-container, .doc-header img {
                display: block;
            }
    ...
    <div class="main-container">
        ...
        <section id="post">
            <div class="container">
                <label for="" class="title">Printable Reports (Transactions)</label>
                <div class="tbl-list">
                    <form method="POST" action="" class="form-sort">
                        <div class="form-inline">
                            ...
                            <button class="btn btn-warning generate" onclick="window.print();">Print</button>
                        </div>
                    </form>
                </div>  
                        ...
                        <tbody>
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $result['toPay'];?></td>
                                    <td><?php echo date('Y/m/d h:i:s A', strtotime($result["pay_date"]));?></td>
                                </tr>
                                ...
                                <?php
                                    ...
                                    if($payment != "" || $fdate != "" || $tdate != "") {

                                        $sql = "SELECT * FROM payment
                                        LEFT JOIN tutors 
                                        ON payment.tutor_id = tutors.id
                                        WHERE payment_option = '$payment' OR reg_date >= '$fdate'
                                        AND reg_date <= '$tdate' ORDER BY id";
