...
<html lang="en">
  ...
  <nav class="navbar">
	...
	<section id="post">
		<div class="container">
            <div class="tbl-list">
                <label for="">Student Pending Request</label>
			    ...
			    <table class="table table-hover table-striped tbl" id="table-list">
					...
					<tbody>
							<?php 
									...
									$sql = "SELECT * FROM students WHERE verification_status = 'Pending' ORDER BY id ASC";
							 	...
							 	<tr>
                                    ...
                                    <td>
                                        <a href="admin_view_std_credentials.php?id=<?php echo $result['id']; ?>" target="_blank"><input type="button" class="btn btn-sm view" value="View Credentials"></a>
                                    </td>
                                    <td>
                                        <form action="std_admin_action.php" method="post">
