...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top"><img class="logo" src="../assets/img/logo_yellow.png" alt="..." />Learn Admin</a>
            ...
            <div class="container">
                    <div class ="content">
			            <h1> Live to Learn</h1>
				            ...
				            <div class="dropdown">
    			                <button class="mainbut" type="submit"><a class="log" href="../admin/admin_login.php">Login</a></button>     

  				                <button class="mainbut" type="submit"><a class="log" href="../admin/admin_reg.php">Register</a></button>
