        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link opt" href="verification_request.php">
                            ...
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    <?php
                                        ...
                                        $query = "SELECT cred_id FROM credibility WHERE receiver_id ='$id' AND req_status = 0 ORDER BY cred_id";  
                                        $query_run = mysqli_query($conn, $query);
                                        $row = mysqli_num_rows($query_run);
                            ...
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    <?php
                                        ...
                                        $query = "SELECT payment_id FROM payment ORDER BY payment_id";  
                                        $query_run = mysqli_query($conn, $query);
                                        $row = mysqli_num_rows($query_run);
                                        echo '<h4> Transaction/s: '.$row.'</h4>';
                                    ?>
                                </div>
                            </div>
                            <div class="col-auto">
